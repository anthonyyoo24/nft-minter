  ...
  return (
    <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <div className="flex flex-1 flex-col items-center mt-10 space-y-6 text-center lg:space-y-0 lg:justify-center">
          <img className="w-80 object-cover pb-10 lg:h-40" src="https://links.papareact.com/bdy" alt="" />
          <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">PAPAFAM Ape Coding Club | NFT Drop</h1>
